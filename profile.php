			...
			<div class="row contact-form pt-md-5">
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:janardhan02102022@email.com" class="text-dark">janardhan02102002@gmail.com</a>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6 wthree-form-left my-lg-0 mt-5">
					...
					<div class="contact-top1">
						<form action="#contact" method="get" class="contact-wthree">
